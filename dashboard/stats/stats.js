...
async function loadStats() {
  try {
    ...
    document.getElementById("sc-osszes").textContent =
      data.osszes_rendeles + " db";
    document.getElementById("sc-bevetel").textContent =
      Number(data.osszes_bevetel).toLocaleString("hu-HU") + " Ft";
    document.getElementById("sc-atlag").textContent =
      Number(data.atlag_bevetel).toFixed(0).toLocaleString("hu-HU") + " Ft";
